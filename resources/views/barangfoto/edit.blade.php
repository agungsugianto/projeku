...
<div class="col-md-12">
  <div class="card card-default widget">
    ...
    <div class="card-body">
      <form action="{{ route('barangfoto.update',$fotobarang->id) }}" method="post" enctype="multipart/form-data" >
        ...
        <div class="form-group {{ $errors->has('foto') ? ' has-error' : '' }}">
          ...
          <img src="{{asset('/img/'.$fotobarang->foto)}}" style="width:250px; height:250px;" alt=""><br><br>
          <input type="file" name="foto" class="form-control" accept="/image" value="{{ $fotobarang->foto }}"  required>
          @if ($errors->has('foto'))
          <span class="help-block">
