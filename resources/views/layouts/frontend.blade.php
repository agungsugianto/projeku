...
<div class="productImage">
	<img src="{{asset('/img/'.$data->foto.'')}}" style="height:400px; width:1100px;"><br><br>
		</div>
		@endforeach
</div>
			...
			<div class="col-md-3 align-self-center">
						<div class="img-wrapper">
							...
							<a href="{{ asset('/img/'.$data->gambar.'')}}" data-lightbox="gallery"  >
								<img src="{{ asset('/img/'.$data->gambar.'')}}" alt="" class="img-fluid"></a>
							</div>
						</div>
					</div>
					@endforeach
	...
	<div class="productBox">
		<div class="imageWrapper">
			<img src="{{('/img/'.$data->foto.'')}}" alt="feature-collection-image" style="height:200px; widht:200px;">
			<div class="productCaption clearfix"><a href="/product/{{$data->slug}}">
										<h4 style="color:orange;">{{$data->nama_barang}}</h4></a><br>
										<h5>Rp. {{$data->harga}}</h5><br><br>
									</div>
		</div>
	</div>
</div>
